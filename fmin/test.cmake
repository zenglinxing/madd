...
target_include_directories(test_fmin-NM PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_fmin-NM PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_fmin-PSO PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_fmin-PSO PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_fmin-Newton-Iteration PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_fmin-Newton-Iteration PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_fmin-Jacobi-Iteration-Sparse PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_fmin-Jacobi-Iteration-Sparse PUBLIC ${thread_base_LIBRARY_DIRS})
