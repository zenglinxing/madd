...
add_executable(test_thread-rwlock thread_base/test/main-rwlock.c)
target_include_directories(test_thread-rwlock PUBLIC thread_base/)
target_link_libraries(test_thread-rwlock PUBLIC madd)
if (${MADD_THREAD_API} STREQUAL "pthread" OR UNIX)
    target_link_libraries(test_thread-rwlock PUBLIC pthread)
endif()
add_test(NAME thread-rwlock COMMAND test_thread-rwlock)