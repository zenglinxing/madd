...
target_include_directories(test_linalg-eigen PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_linalg-eigen PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_linalg-generalized-eigen PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_linalg-generalized-eigen PUBLIC ${thread_base_LIBRARY_DIRS})
...
if (ENABLE_CUDA)
    if (${CUDA_VERSION} VERSION_GREATER_EQUAL 12.6)
        ...
        target_include_directories(test_linalg-eigen-cuda PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
        target_link_directories(test_linalg-eigen-cuda PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_linalg-linear-equations PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_linalg-linear-equations PUBLIC ${thread_base_LIBRARY_DIRS})
...
if (ENABLE_CUDA)
    ...
    target_include_directories(test_linalg-linear-equations-cuda PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
    target_link_directories(test_linalg-linear-equations-cuda PUBLIC ${thread_base_LIBRARY_DIRS})
    ...
    if (${CUDA_VERSION} VERSION_GREATER_EQUAL 11.1)
        ...
        target_include_directories(test_linalg-linear-equations-cuda64 PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
        target_link_directories(test_linalg-linear-equations-cuda64 PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_linalg-matrix-multiply PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_linalg-matrix-multiply PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_linalg-matrix-inverse PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_linalg-matrix-inverse PUBLIC ${thread_base_LIBRARY_DIRS})
...
target_include_directories(test_linalg-determinant PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
target_link_directories(test_linalg-determinant PUBLIC ${thread_base_LIBRARY_DIRS})
...
if (ENABLE_CUDA)
    ...
    target_include_directories(test_linalg-determinant-cuda PUBLIC ${CMAKE_CURRENT_SOURCE_DIR} ${thread_base_INCLUDE_DIRS})
    target_link_directories(test_linalg-determinant-cuda PUBLIC ${thread_base_LIBRARY_DIRS})
