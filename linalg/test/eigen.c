...
int main(int argc, char *argv[])
{
    ...
    bool flag_real_left_verified = true, flag_real_right_verified = true, flag_2_real_verified = true;
    ...
    if (vl2[0].real != -sqrt2 || vl2[1].real != -sqrt2 || vl2[2].imag != -vl2[3].imag || fabs(vl2[2].imag) != sqrt2){
        flag_2_real_verified = false;
    }
    if (vr2[0].real != sqrt2 || vr2[1].real != sqrt2 || vr2[2].imag != -vr2[3].imag || fabs(vr2[2].imag) != sqrt2){
        flag_2_real_verified = false;
    }
    ...
    printf("2 X 2 Real Matrix Tests:\n");
    ...
    if (!flag_real_left_verified || !flag_real_right_verified || !flag_2_real_verified){
        exit(EXIT_FAILURE);
    }else{
