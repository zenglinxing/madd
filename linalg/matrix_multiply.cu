...
MATRIX_MULTIPLY_CUDA__ALGORITHM(double, cublasDgemm_64, Matrix_Transpose)

bool Matrix_Multiply_cuda_f32(int64_t m, int64_t n, int64_t l,
                              float *a, float *b, float *res)
MATRIX_MULTIPLY_CUDA__ALGORITHM(float, cublasSgemm_64, Matrix_Transpose_f32)

bool Matrix_Multiply_cuda_c64(int64_t m, int64_t n, int64_t l,
                              Cnum *a, Cnum *b, Cnum *res)
MATRIX_MULTIPLY_CUDA_CNUM__ALGORITHM(cuDoubleComplex, cublasZgemm_64, Matrix_Transpose_c64)

bool Matrix_Multiply_cuda_c32(int64_t m, int64_t n, int64_t l,
                              Cnum32 *a, Cnum32 *b, Cnum32 *res)
MATRIX_MULTIPLY_CUDA_CNUM__ALGORITHM(cuComplex, cublasCgemm_64, Matrix_Transpose_c32)