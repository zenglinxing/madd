...
{ \
    ...
    dpoly.mem = (num_type*)malloc(((uint64_t)n_pos+n_neg+1)*sizeof(num_type)); \
...
POLY1D_CREATE_CNUM__ALGORITHM(Cnum, uint64_t, Poly1d_c128)

Poly1d_c128 Poly1d_Init_c128(uint64_t n, uint64_t _n, __complex128 *a)
POLY1D_INIT__ALGORITHM(__complex128, Poly1d_c128)

void Poly1d_Free_c128(Poly1d_c128 poly)
POLY1D_FREE__ALGORITHM

__complex128 Poly1d_Value_c128(__complex128 x, Poly1d_c128 poly)
POLY1D_VALUE_CNUM__ALGORITHM(Cnum, uint64_t, Cnum_Add_f128, Real_Div_Cnum_f128, Cnum_Div_f128, Cnum_Mul_f128)

void Poly1d_Derivative_c128(Poly1d_c128 poly,Poly1d_c128 dpoly)
POLY1D_DERIVATIVE_CNUM__ALGORITHM(Cnum_c128, uint64_t, Cnum_Mul_Real_f128, Cnum_Value_f128)

void Poly1d_Derivative_N_order_c128_Allocated(const Poly1d_c128 poly, uint64_t n_order, Poly1d_c128 *dpoly)
POLY1D_DERIVATIVE_N_ORDER_ALLOCATED__ALGORITHM(__complex128, uint64_t, Poly1d_c128)

Poly1d_QC Poly1d_Derivative_N_order_c128(const Poly1d_c128 poly, uint64_t n_order)
POLY1D_DERIVATIVE_N_ORDER__ALGORITHM(Cnum_f128, uint64_t, Poly1d_c128, Poly1d_Derivative_N_order_c128_Allocated)

__complex128 Poly1d_Integrate_c128(Poly1d_c128 poly,Poly1d_c128 ipoly)
