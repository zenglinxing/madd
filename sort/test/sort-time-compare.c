...
int main(int argc, char *argv[])
{
    ...
    double time_counting = (clock_counting2 - clock_counting1) / (double)RAND_MAX;
    printf("counting sort:\t%e sec\n", time_counting);
    ...
    double time_insertion = (clock_insertion2 - clock_insertion1) / (double)RAND_MAX;
    printf("insertion sort:\t%e sec\n", time_insertion);
    ...
    clock_merge2 = clock();
    double time_merge = (clock_merge2 - clock_merge1) / (double)RAND_MAX;
    printf("merge sort:\t%e sec\n", time_merge);
    ...
    clock_quick2 = clock();
    double time_quick = (clock_quick2 - clock_quick1) / (double)RAND_MAX;
    printf("quicksort:\t%e sec\n", time_quick);
    ...
    clock_shell2 = clock();
    double time_shell = (clock_shell2 - clock_shell1) / (double)RAND_MAX;
    printf("shell sort:\t%e sec\n", time_shell);
